...
var POINTS_PER_LAP = 7;
var SHADOW_STRENGTH = 6;



export const spiral = function() {
...
function step() {
    ...
    time += velocity;
    velocity += ( velocityTarget - velocity ) * 0.01;
...
function onMouseMove( event ) {
    ...
    var vx = ( event.clientX - lastX ) / 1000;
    var vy = ( event.clientY - lastY ) / 1000;
...
function onTouchMove( event ) {
    ...
    var vx = ( event.touches[0].clientX - lastX ) / 1000;
    var vy = ( event.touches[0].clientY - lastY ) / 1000;
